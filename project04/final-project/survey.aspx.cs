    ...
    public partial class survey : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    // Build the file path
                    string filePath = $@"C:\\Users\almom\\OneDrive\\سطح المكتب\\mustafa1\final-project\files\\Feedback\\{name}_{course}.txt";
                        ...
                        try
                        {
                            ...
                            foreach (string line in fileLines)
                            {
                                ...
                                if (parts.Length >= 2)
                                {
                                    ...
                                    {
                                        Text = question
                                        // No additional styling for the question label
                                    };
                                    ...
                                    {
                                        Text = answer,
                                        CssClass = "form-label custom-text-color" // Apply Bootstrap class for answer color
                                    };
