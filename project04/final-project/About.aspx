...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container about-container">
            <h1>About Us</h1>
            <p>Welcome to our e-learning platform! We are dedicated to providing the best online courses to help you advance your skills.</p>
            <h2>Our Mission</h2>
            ...
            <ul>
                <li>Quality: Ensuring that our courses are of the highest quality.</li>
                <li>Integrity: Operating with honesty and transparency.</li>
                <li>Innovation: Continuously improving our platform and course offerings.</li>
                <li>Inclusivity: Making education accessible to everyone.</li>
            </ul>
        </div>
    </form>
